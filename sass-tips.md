...
Most of what follows is based on our notes from a  [Treehouse](https://teamtreehouse.com/) course given by [Hampton Catlin](http://www.hamptoncatlin.com/).  It would seem this course is no longer available. 
...
Partials  are  named with underscore (_uname.scss, for example)
...
####12.  Saas -- watch Alternatives
    ...
    sass --l  mystyle.scss  // line-comments, shorthand for above command
...
~~~
&nbsp; 
##### 17b.  Each loop within mixin with any number of arguments
...
#### 18.  Mixins. Optional Arguments and Parameters
...
~~~
##### 18b.  But can also give default values to mixin
...
~~~
#### 18d. Null as Mixin Default Argument
...
~~~
####  19. Mixin: include warning message
...
Mainly from our notes on  [Treehouse](https://teamtreehouse.com/) advanced Sass course given by [Dale Sande]( http://www.dalesande.com/ ). 

#### 20. list-maps and map-get()
...
#### 21.  Pass code block to Mixin with '@content' directive
...
Putting '!default' at the end of a variable declaration ensures that if a variable is already assiged it will not be over-written, *unless the original assignment is to null*  (in which case it will be over-written). 
...
#### 25. To Persistently Edit Sass from Chrome Browser
